                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="semester" class="form-control form-select select2 select2-hidden-accessible @error('semester') is-invalid state-invalid @enderror" data-bs-placeholder="Pilih Semester" tabindex="-1" aria-hidden="true">
                                        <option value="1" {{$semester->semester==1? 'checked':''}}>Semester 1</option> 
                                        <option value="2" {{$semester->semester==2? 'checked':''}}>Semester 2</option> 
                                    </select> 
                                    @error('semester')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tahun" class="form-control @error('tahun') is-invalid state-invalid @enderror" placeholder="Tahun" value="{{ old('tahun',$semester->tahun) }}" autofocus>
                                    @error('tahun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
