                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Nama" value="{{ old('name', $user->name) }}" autofocus>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username"
                                            class="form-control @error('username') is-invalid state-invalid @enderror"
                                            placeholder="Username" value="{{ old('username', $user->username) }}" autofocus>
                                        @error('username')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select name="role" class="form-control form-select select2">
                                            ...
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->id }}"
                                                    {{ $role->id == $role_satuan->id ? 'selected' : '' }}>
                                                    {{ $role->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-select select2">
                                            ...
                                            <option value="0"
                                                {{ old('status', $user->status) == 0 ? 'selected' : '' }}>Tidak Aktif
                                            </option>
                                        </select>
                                            ...
                                            <div class="panel-heading1 ">
                                                <h4 class="panel-title1">
                                                    <a class="accordion-toggle collapsed" data-bs-toggle="collapse"
                                                        ...
                                                        aria-expanded="false">Ganti Password</a>
                                                </h4>
                                            </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="current_password"
                                                            class="form-control @error('current_password') is-invalid state-invalid @enderror"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="conf_new_password"
                                                            class="form-control @error('conf_new_password') is-invalid state-invalid @enderror"
                                                            placeholder="Confirm Password">
                                                    ...
                                                    <div class="text-end">
                                                        <button type="submit" class="btn btn-primary"><i
                                                                class="fa fa-unlock-alt"></i> Ganti Password</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
