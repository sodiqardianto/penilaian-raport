                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namakategorinilai" class="form-control @error('namakategorinilai') is-invalid state-invalid @enderror" placeholder="Masukan Kategori" value="{{ old('namakategorinilai',$kategori->namakategorinilai) }}" autofocus>
